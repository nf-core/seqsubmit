...
| `binning_parameters`        | Yes         | Arguments used to bin data different from default, e.g. -min_contig_length 1000, otherwise put 'default'.                                                                                                                                                                                                                                                                                                            |
